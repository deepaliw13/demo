...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Demo_News::save')) {
            ...
            $this->buttonList->add(
                ...
                [
                    ...
                    'data_attribute' => [
                        'mage-init' => [
                            'button' => ['news' => 'saveAndContinueEdit', 'target' => '#edit_form'],
                        ],
                    ]
                ],
                -100
        ...
        if ($this->_isAllowedAction('Demo_News::news_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('news')->getId()) {
            return __("Edit Form '%1'", $this->escapeHtml($this->_coreRegistry->registry('news')->getTitle()));
        } else {
            return __('New Form');
        }
    }
